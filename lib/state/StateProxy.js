...
class StateProxy {
  ...
  #onPropCreate(prop, updatedObject, updatedState) {
    observers.runCallbacks(
      observers.EnumTypes.CREATE, updatedObject, updatedState, prop
    )
    observers.runCallbacks(
      observers.EnumTypes.SET, updatedObject, updatedState, prop
    )
  }
  ...
  #onPropDelete(prop, updatedObject, updatedState, oldValue) {
    observers.runCallbacks(
      observers.EnumTypes.DELETE, updatedObject, updatedState, prop, oldValue
    )
  }
  ...
  #onPropUpdate(prop, updatedObject, updatedState, oldValue) {
    // State subs
    observers.runCallbacks(
      observers.EnumTypes.CHANGE, updatedObject, updatedState, prop, oldValue
    )
    observers.runCallbacks(
      observers.EnumTypes.SET, updatedObject, updatedState, prop, oldValue
    )
