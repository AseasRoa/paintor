...
/** @type {{ receiver: State | undefined, prop: ObjectKey | undefined }} */
const lastGetData = { receiver: undefined, prop: undefined }
...
class StateProxy {
  ...
  #handler = {
    get: (target, prop, receiver) => {
      ...
      lastGetData.receiver = receiver
      lastGetData.prop = prop
  ...
  #onPropCreate(prop, updatedObject, updatedState) {
    observers.runCallbacks('create', updatedObject, updatedState, prop)
    observers.runCallbacks('set', updatedObject, updatedState, prop)
  }
  ...
  #onPropDelete(prop, updatedObject, updatedState, oldValue) {
    observers.runCallbacks('delete', updatedObject, updatedState, prop, oldValue)
  }
  ...
  #onPropUpdate(prop, updatedObject, updatedState, oldValue) {
    // State subs
    observers.runCallbacks('change', updatedObject, updatedState, prop, oldValue)
    observers.runCallbacks('set', updatedObject, updatedState, prop, oldValue)
