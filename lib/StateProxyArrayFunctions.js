import { EnumStateAction, symState } from './constants.js'
...
export class StateProxyArrayFunctions {
  ...
  #arrayFnPush = (...args) => {
    ...
    for (const arg of args) {
      newLength += 1
      // This removes the symState property
      const objCopy = arg instanceof Object ? { ...arg } : arg

      receiver[newLength] = objCopy
    }
