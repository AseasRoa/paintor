...
class StateProxyArrayFunctions {
  /** @type {TargetObject} */
  #target
  ...
  sort = (...args) => {
    ...
    this.#callback(EnumStateAction.ARRAY_SORT, receiver, args)
  ...
  splice = (...args) => {
    ...
    this.#callback(EnumStateAction.ARRAY_SPLICE, receiver, args)
    this.#touchLength(receiver, prevLength)
...
export { StateProxyArrayFunctions }
