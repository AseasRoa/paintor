         ...
         */
          ...
          if (
            ...
            if (target[prop] instanceof Object && value instanceof Object) {
              ...
              /**
               * When in an Object a whole Array is set, its new values
               * could be primitive and non-reactive. Loop through the
               * array and for each primitive value that is changed,
