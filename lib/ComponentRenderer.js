...
import { unsubscribe } from './state/subscriptions.js'
...
class ComponentRenderer {
   ...
   * @param {Template | undefined} template
   */
  ...
  #renderElements(window, container, templates, htmlOptions = {}) {
    const tree = new TemplateTreeClass(
      window, container, templates, this.#translator,
    )
    tree.render().then(() => undefined)

    this.#finalHtmlCode = tree.getHtmlCode(htmlOptions)
    this.#finalElements.push(tree.getCreatedElements())
  }
}
